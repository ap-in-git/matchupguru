     ...
     <div class="form-group">
       <label class="b-blue-border ">Data</label>
        <div class="radio radio-primary">
            <input type="radio" name="data" id="me" disabled  >
            <label for="me">
               Me
            </label>
        </div>
        ...
        <div class="radio radio-primary">
            <input type="radio" name="data"  id="me-all" disabled>
            <label for="me-all">
               Me vs all
            </label>
        </div>
...
<div class="col-sm-12" v-if="table_data_type==2">
